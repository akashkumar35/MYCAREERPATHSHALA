...
function News() {
  ...
  return (
    <div className='news_main_container'>
          <div className='news_main_container_child'>
        <div className='news_main_container_top'>
      <p1 className="news_text">News & blogs</p1>
</div>
<div className='news_main_container_bottom'>
    {
        newsarr.map((items)=>{
            return(
